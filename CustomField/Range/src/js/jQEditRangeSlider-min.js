/*! jQRangeSlider 5.8.2 - 2023-10-19 - Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.*/
!function (a, b) {
    "use strict";
    a.widget("ui.rangeSliderMouseTouch", a.ui.mouse, {
        enabled: !0, _mouseInit: function () {
            var a = this;
            this._super(), this._mouseDownEvent = !1, this.element.bind("touchstart." + this.widgetName, function (b) {
                return a._touchStart(b)
            })
        }, _mouseDestroy: function () {
            a(document).unbind("touchmove." + this.widgetName, this._touchMoveDelegate).unbind("touchend." + this.widgetName, this._touchEndDelegate), this._super()
        }, enable: function () {
            this.enabled = !0
        }, disable: function () {
            this.enabled = !1
        }, destroy: function () {
            this._mouseDestroy(), this._super(), this._mouseInit = null
            ...
            return this.enabled ? this._super(a) : !1
    ...
    a.widget("ui.rangeSliderDraggable", a.ui.rangeSliderMouseTouch, {
        cache: null, options: {containment: null}, _create: function () {
            this._super(), setTimeout(a.proxy(this._initElementIfNotDestroyed, this), 10)
        }, destroy: function () {
            this.cache = null, this._super()
    ...
    a.widget("ui.rangeSlider", {
        ...
        ruler: null,
        _create: function () {
            this._super(), this._setDefaultValues(), this.labels = {
                left: null,
                right: null,
                leftDisplayed: !0,
                rightDisplayed: !0
        ...
        _createElements: function () {
            "absolute" !== this.element.css("position") && this.element.css("position", "relative"), this.element.addClass("ui-rangeSlider"), this.container = a("<div class='ui-rangeSlider-container' />").css("position", "absolute").appendTo(this.element), this.innerBar = a("<div classإ='ui-rangeSlider-innerBar' />").css("position", "absolute").css("top", 0).css("left", 0), this._createHandles(), this._createBar(), this.container.prepend(this.innerBar), this._createArrows(), "hide" !== this.options.valueLabels ? this._createLabels() : this._destroyLabels(), this._updateRuler(), this.options.enabled || this._toggle(this.options.enabled)
        },
        ...
        _getFormatter: function () {
            return this.options.formatter === !1 || null === this.options.formatter ? this._defaultFormatter.bind(this) : this.options.formatter
        },
        ...
        destroy: function () {
            this.element.removeClass("ui-rangeSlider-withArrows ui-rangeSlider-noArrow ui-rangeSlider-disabled"), this._destroyWidgets(), this._destroyElements(), this.element.removeClass("ui-rangeSlider"), this.options = null, a(window).unbind("resize", this._resizeProxy), this._resizeProxy = null, this._bindResize = null, this._super()
        },
    ...
    a.widget("ui.rangeSliderHandle", a.ui.rangeSliderDraggable, {
        ...
        _initElement: function () {
            this._super(), 0 === this.cache.parent.width || null === this.cache.parent.width ? setTimeout(a.proxy(this._initElementIfNotDestroyed, this), 500) : (this._position(this._value), this._triggerMouseEvent("initialize"))
        },
        _bounds: function () {
            return this.options.bounds
        },
        _cache: function () {
            this._super(), this._cacheParent()
        },
        _cacheParent: function () {
            var a = this.element.parent();
            this.cache.parent = {
        ...
        _applyPosition: function (a) {
            this._super(a), this._left = a, this._setValue(this._getValueForPosition(a)), this._triggerMouseEvent("moving")
        },
        _prepareEventData: function () {
            var a = this._super();
            return a.value = this._value, a
        },
    ...
    a.widget("ui.rangeSliderBar", a.ui.rangeSliderDraggable, {
        options: {
            ...
            this._super(), this.element.css("position", "absolute").css("top", 0).addClass("ui-rangeSlider-bar"), this.options.leftHandle.bind("initialize", a.proxy(this._onInitialized, this)).bind("mousestart", a.proxy(this._cache, this)).bind("stop", a.proxy(this._onHandleStop, this)), this.options.rightHandle.bind("initialize", a.proxy(this._onInitialized, this)).bind("mousestart", a.proxy(this._cache, this)).bind("stop", a.proxy(this._onHandleStop, this)), this._bindHandles(), this._values = this.options.values, this._setWheelModeOption(this.options.wheelMode)
        }, destroy: function () {
            this.options.leftHandle.unbind(".bar"), this.options.rightHandle.unbind(".bar"), this.options = null, this._super()
        }, _setOption: function (a, b) {
            ...
            this._super(), this._cacheHandles()
            ...
            this._super(a), this._deactivateRange()
        }, _mouseStop: function (a) {
            this._super(a), this._cacheHandles(), this._values.min = this._leftHandle("value"), this._values.max = this._rightHandle("value"), this._reactivateRange(), this._leftHandle().trigger("stop"), this._rightHandle().trigger("stop")
            ...
            var b, c = {};
            return c.left = this._super(a), c.left = this._leftHandle("position", c.left), b = this._rightHandle("position", c.left + this.cache.width.outer - this.cache.rightHandle.width), c.width = b - c.left + this.cache.rightHandle.width, c
        }, _applyPosition: function (a) {
            this._super(a.left), this.element.width(a.width)
    ...
    function c(b, c, d, e) {
        this.label1 = b, this.label2 = c, this.type = d, this.options = e, this.handle1 = this.label1[this.type]("option", "handle"), this.handle2 = this.label2[this.type]("option", "handle"), this.cache = null, this.left = b, this.right = c, this.moving = !1, this.initialized = !1, this.updating = !1, this.Init = function () {
            this.BindHandle(this.handle1), this.BindHandle(this.handle2), "show" === this.options.show ? (setTimeout(a.proxy(this.PositionLabels, this), 1),
                this.initialized = !0) : setTimeout(a.proxy(this.AfterInit, this), 1e3), this._resizeProxy = a.proxy(this.onWindowResize, this), a(window).resize(this._resizeProxy)
    ...
    a.widget("ui.rangeSliderLabel", a.ui.rangeSliderMouseTouch, {
        ...
        destroy: function () {
            this.options.handle.unbind(".label"), this.options.handle = null, this._valueContainer = null, this._innerElement = null, this.element.empty(), this._positionner && (this._positionner.Destroy(), this._positionner = null), this._super()
        },
        _createElements: function () {
        ...
        _display: function (a) {
            this.options.formatter === !1 ? this._displayText(Math.round(a)) : this._displayText(this.options.formatter(a, this.options.isLeft)), this._value = a
        },
    ...
    a.widget("ui.editRangeSlider", a.ui.rangeSlider, {
        options: {type: "text", round: 1}, _create: function () {
            this._super(), this.element.addClass("ui-editRangeSlider")
        }, destroy: function () {
            this.element.removeClass("ui-editRangeSlider"), this._super()
        }, _setOption: function (a, b) {
            ("type" === a || "step" === a) && this._setLabelOption(a, b), "type" === a && (this.options[a] = null === this.labels.left ? b : this._leftLabel("option", a)), this._super(label, handle)
            ...
            return this._addPropertiesToParameter(c)
    ...
    a.widget("ui.editRangeSliderLabel", a.ui.rangeSliderLabel, {
        options: {type: "text", step: !1, id: ""}, _input: null, _text: "", _create: function () {
            this._super(), this._createInput()
        }, _setOption: function (a, b) {
            "type" === a ? this._setTypeOption(b) : "step" === a && this._setStepOption(b), this._super(a, b)
            ...
            this._super(a, b), this._setInputName()
            ...
            this._super(), this._input.attr("disabled", null)
        }, disable: function () {
            this._super(), this._input.attr("disabled", "disabled")
        }
    })
}(jQuery);
...
var simpleRating = class {
    ...
    init() {
        ...
        if (this.options.listview) {
            ...
            if (this.options.emotion) {
                for (var i = 0; i < this.maxemotions; i++) {
                    html += '<i class="fa" data-rating="' + (i + 1) + '" alt="' + this.emotionstitle[i] + '" title="' + this.emotionstitle[i] + '">' + this.emotionicons[0] + '</i>';
                }
            } else {
        ...
        if (this.options.emotion) {
            $("#" + this.randid).html(this.emotionstitle[this.rating]);
        }
    }
    ...
    setstars(rating) {
        ...
        if (this.options.listview) {
            ...
            $("#" + this.randid).html((this.emotionstitle[rating]));
        } else {
            if (this.options.emotion) {
                //test
                for (var i = 0; i < this.maxemotions; i++) {
